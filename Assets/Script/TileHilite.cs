...
#region Attributes
	...
	void Start ()
	{
		...
		vertices[0] = new Vector3(-he.TerrainPartition.TILE_HEIGHT, 0, 0);
		vertices[1] = new Vector3(0, 0, -he.TerrainPartition.TILE_WIDTH);
		vertices[2] = new Vector3(he.TerrainPartition.TILE_HEIGHT, 0, 0);
		vertices[3] = new Vector3(0, 0, he.TerrainPartition.TILE_WIDTH);
