...
public class SpriteManager : MonoBehaviourEx
{
	...
	// The material to use for the sprites
	...
	// The plane in which to create the sprites
	public SPRITE_PLANE plane;
	// Which way to wind polygons
	public WINDING_ORDER winding = WINDING_ORDER.CCW;
	// Automatically recalculate the bounds of the mesh when vertices change?
	public bool autoUpdateBounds = false;
