...
#region Enums
		...
		public bool CheckDirection(Direction Dir, float Ratio)
		{
			...
			he.TerrainTileHandle last_tile = new he.TerrainTileHandle(TerrainPartition.PARTITION_WIDTH - 1, TerrainPartition.PARTITION_HEIGHT - 1, m_TerrainManager.width - 1, m_TerrainManager.height - 1);
