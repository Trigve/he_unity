...
#region Interface
		...
		public Vector3 GetPosition(he.TerrainTileHandle Tile, short Vertex)
		{
		...
		public Vector3 GetPosition(he.TerrainTileHandle Tile)
		{
		...
		*/
		public he.TerrainTileHandle[] GetAllNeighbors(he.TerrainTileHandle Tile)
		{
			var output = new he.TerrainTileHandle[8];
		...
		//! Get tile instance.
		public he.TerrainTile GetTile(he.TerrainTileHandle TileHandle)
		{
			return GetPartition((ushort)TileHandle.partitionX, (ushort)TileHandle.partitionY).GetTile(TileHandle.x, TileHandle.y);
		}

		//! Get neighbor tile.
		public he.TerrainTileHandle GetTile(he.TerrainTileHandle Tile, Direction Dir)
		{
		...
		public void SetTileTerrainType(he.TerrainTileHandle TileHandle, byte TerrainType)
		{
			he.TerrainTile tile = GetTile(TileHandle);
			...
			he.TerrainTileHandle[] near_neighbors = GetAllNeighbors(TileHandle);
...
#region Interface Static
		public static Direction GetDirection(he.TerrainTileHandle From, he.TerrainTileHandle To)
		{
...
#region Operations
		...
		//! Get tile checked
		private he.TerrainTileHandle GetTileChecked(int PartitionX, int PartitionY, int X, int Y)
		{
			...
			return new he.TerrainTileHandle(X, Y, PartitionX, PartitionY);
		}
...
#region Construction
		public void This(ushort Width, ushort Height, he.TerrainTileSet TileSet)
		{
			m_Width = Width;
			m_Height = Height;
			m_Partitions = new TerrainPartition[m_Width * m_Height];
